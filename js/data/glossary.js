...
window.GLOSSARY = [
 ...
 {
  "term": "cell membrane",
  "def": "The partially permeable layer round the cytoplasm of every cell, controlling what enters and leaves it. In a plant cell it lies just inside the cell wall.",
  "forms": [
   "plasma membrane"
  ]
 },
 ...
 {
  "term": "vacuole",
  "def": "The large, permanent, fluid-filled space in the centre of a plant cell. Water entering it makes the cell turgid; water leaving it makes the cell flaccid.",
  "plural": "vacuoles"
 },
 {
  "term": "cellulose",
 ...
 {
  "term": "coleoptile",
  "def": "The hollow sheath that covers the first shoot of a grass seedling — oat, maize, wheat — as it pushes up through the soil, protecting the folded first leaf inside. Its tip makes the auxin and detects the light. The classic auxin experiments were all done on coleoptiles, because a coleoptile is a straight hollow tube with no leaves in the way: you can cut the tip off, put it back, cap it, or slide a barrier into it. 0610 asks only for the shoot tip.",
  "ext": true,
  "forms": [
   "coleoptiles"
  ]
 ...
 },
 {
  ...
  "def": "The movement of water from the roots, up the xylem, to the leaves. The stream is the movement; the force that drives it is the transpiration pull.",
  "sup": true
 },
 {
 ...
 {
  "term": "succulent",
  "def": "A xerophyte with thick, fleshy stems or leaves that hold a store of water, so the plant can live through a dry season. A cactus is one.",
  "sup": true
 },
 {
  "term": "marram grass",
  "def": "The grass that grows on sand dunes, and the xerophyte the exam uses most: its leaves roll into a tube, with the stomata sunk in pits on the inside.",
  "forms": [
   "marram"
  ],
  "sup": true
