...
| `laennec-necker-*` | Laennec listening to a patient's chest at the Necker Hospital, 1816 (the "A roll of paper, not a stethoscope" card) | [Laennec and the use of the stethoscope at the Hospital Necker, Wellcome L0007797](https://commons.wikimedia.org/wiki/File:Laennec_and_the_use_of_the_stethoscope_at_the_Hospital_Necker_Wellcome_L0007797.jpg) — a heliogravure after Théobald Chartran's fresco in the Sorbonne; cropped to the picture, without its printed title | Wellcome Collection, CC BY 4.0 |
| `laennec-stethoscopes-*` | Laennec's wooden stethoscopes of 1819 and 1826 (the same card) | [Laennec stethoscope of 1819, Wellcome M0016400](https://commons.wikimedia.org/wiki/File:Laennec_stethoscope_of_1819_Wellcome_M0016400.jpg) — Plate I of Laennec's treatise; cropped to Figs 1 and 2 | Wellcome Collection, CC BY 4.0 |
| `sei-whale-heart-*` | The preserved heart of a sei whale in its case at the Kulturama museum, Zürich (the "The largest heart on Earth" card) | [Sei whale heart](https://commons.wikimedia.org/wiki/File:Sei_whale_heart.jpg) — Wikimedia Commons, photo by Tiia Monto; the 1920 px copy, not cropped | CC BY-SA 3.0 — outside the lab's PD/CC0/CC BY rule: Daniel chose it on 26 Sep 2026 (no openly licensed photo of a blue whale's heart exists) |
| `octopus-live-*` | A live common octopus, *Octopus vulgaris* (the "A heart for each gill" card) | [Three Times the Love ♥♥♥](https://commons.wikimedia.org/wiki/File:Three_Times_the_Love_%E2%99%A5%E2%99%A5%E2%99%A5_(48955284726).jpg) — Wikimedia Commons, from Flickr, photo by Laszlo Ilyes; not cropped | CC BY 2.0 |
| `pulse-wrist-1140.jpg` | Taking a radial pulse: two fingertips on the thumb side of a left wrist, the thumb up (the "Count a pulse" widget, under its drawn artery and labels) | [Pulse2.jpg](https://commons.wikimedia.org/wiki/File:Pulse2.jpg) — Wikimedia Commons, photo by Mnokel, 2009; colour cast corrected (white balance, slight contrast and sharpening) and cropped to the forearm, wrist, thumb and fingertips | Public domain |
| `hummingbird-*` | An Anna's hummingbird hovering at a red flower (the "The fastest heart" card) | [Anna's hummingbird in Washington](https://commons.wikimedia.org/wiki/File:Anna%27s_hummingbird_in_Washington_(53694694738).jpg) — US Fish and Wildlife Service, Pacific Region, 2022; not cropped | Public domain |
| `harvey-veins-*` | William Harvey's figures 3 and 4 (1628): bound forearms, fingers pressing the veins at their valves (the "The man who counted the blood" card) | [W. Harvey; Exercitatio anatomica...; valves in forearm, Wellcome L0019696](https://commons.wikimedia.org/wiki/File:W._Harvey;_Exercitatio_anatomica...;_valves_in_forearm._Wellcome_L0019696.jpg); not cropped | Wellcome Collection, CC BY 4.0 |
| `icefish-*` | The Antarctic rockcod (red-blooded) above the blackfin icefish (white-blooded) (the "A fish with no red blood cells" card) | [Two Notothenioidei](https://commons.wikimedia.org/wiki/File:Two_Notothenioidei.png) — photo by H. William Detrich, from Schartl (2014), *Disease Models & Mechanisms*, doi:10.1242/dmm.012245; not cropped | CC BY 3.0 |
| `cardiac-muscle-*` | Heart muscle fibres, a capillary and a magnified intercalated disc with a mitochondrion (the "Three billion beats" card) | [1020 Cardiac Muscle](https://commons.wikimedia.org/wiki/File:1020_Cardiac_Muscle.jpg) — OpenStax, *Anatomy and Physiology* (2016), figure 10.20; not cropped | CC BY 4.0 |
| `haemophilia-tree-*` | A simplified family tree of haemophilia in Queen Victoria's descendants (the "Queen Victoria's bleeding family" card) | Drawn for this lab (26 September 2026) from the facts in [Haemophilia family tree](https://commons.wikimedia.org/wiki/File:Haemophilia_family_tree.GIF) (Wikimedia Commons, public domain): only the family members on the gene's path; standard symbols | The lab's own drawing, from a public domain source |
